...
namespace Project_1
{
    public partial class View_Cart : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string sel = "select Product_Price from Product where Product_Id=" + txtpid + "";
            string pid = ob.Fn_Scalar(sel);
            int proid = Convert.ToInt32(pid);
            int qnty = Convert.ToInt32(txtqty.Text);
            int price_tot = proid * qnty;
            string strup = "update Cart set Quantity='" + txtqty.Text + "' and Total_Price="+price_tot+"  where Product_Id=" +Session["pid"]+ " and Cart_Id="+getid+"";
